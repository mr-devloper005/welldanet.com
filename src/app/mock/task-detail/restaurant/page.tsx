...
import { ArrowRight, CalendarClock, CheckCircle2, Clock3, Globe, MapPin, Phone, Star, Tag } from 'lucide-react'
...
const mockTask = {
  ...
  website: 'https://saffronember.example',
  summary:
    'Saffron Ember Kitchen serves regional Indian tasting menus, live tandoor specials, and curated mocktail pairings in a modern dining space.',
  highlights: ['Live tandoor counter', 'Family and private dining zones', 'Vegetarian and Jain menu options', 'Online reservations and takeaway'],
  hours: [
    ['Mon-Thu', '12:00 PM - 11:00 PM'],
    ['Friday', '12:00 PM - 12:00 AM'],
    ['Sat-Sun', '11:00 AM - 12:00 AM'],
  ],
  services: ['Dine-in', 'Private dining', 'Delivery in 6 km radius', 'Corporate catering', 'Birthday event setup', 'Chef tasting menu'],
...
export default function RestaurantMockTaskDetailPage() {
  return (
    <PageShell heroAccent eyebrow="Mock Detail" title="Restaurant Detail Mock" description="A restaurant-style mock detail layout for hospitality and food listing flows.">
      <div className="mb-6 flex flex-wrap gap-2">
        ...
        <Link href="/mock/task-detail/restaurant" className="inline-flex items-center rounded-full bg-slate-950 px-4 py-2 text-xs font-semibold uppercase tracking-[0.14em] text-white">Restaurant</Link>
            ...
            <div className="relative h-[340px] sm:h-[420px]">
              ...
              <div className="absolute inset-x-0 bottom-0 p-5 sm:p-7">
                <div className="flex flex-wrap items-center gap-2">
                  ...
                  <Badge variant="secondary" className="rounded-full bg-slate-900/75 text-white">Popular Choice</Badge>
                </div>
        ...
        <aside className="space-y-6">
          <section className="site-surface-card rounded-[var(--site-radius)] p-6">
            ...
            <div className="mt-5 grid gap-2">
              <Button asChild><a href={mockTask.website} target="_blank" rel="noreferrer">Reserve Table <ArrowRight className="ml-1 h-4 w-4" /></a></Button>
          ...
          <section className="site-surface-card rounded-[var(--site-radius)] p-6">
            ...
            <p className="mt-4 inline-flex items-center gap-2 rounded-full bg-emerald-50 px-3 py-1 text-xs font-semibold text-emerald-800"><CalendarClock className="h-3.5 w-3.5" />Kitchen closes in 2h 10m</p>
          </section>
        </aside>
      </div>
    </PageShell>
